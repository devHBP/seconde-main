<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight flex justify-between">
            Liste des états de produit
            <div>
                <a href="{{ route('admin.state.create') }}" class="ml-4 px-4 py-2 bg-lime-600 text-white rounded hover:bg-lime-700">
                    Nouvel état
                </a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white dark:bg-gray-800 text-sm text-center">
                                <a href="{{ route('admin.state.modify', $state) }}" class="text-lime-600 hover:text-lime-900 mr-2">Modifier</a>
